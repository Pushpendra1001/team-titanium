                    ...
                    <div className="md:w-8/12 lg:ml-6 lg:w-5/12">
                        ...
                        <form>
                            <div className="relative z-0 w-full mb-6 group">
                                <input type="text" name="floating_name" id="name" className="px-1 text-gray-500 rounded-md block py-2.5 w-full text-sm bg-transparent border-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-brand-ember-l-3 peer" placeholder=" " required />
                                <label htmlFor="name" className="bg-white left-2 px-1 z-10 peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 origin-[0] peer-focus:left-2 peer-focus:text-brand-ember-l-3 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Enter Your Name</label>
                            </div>
                            <div className="relative z-0 w-full mb-6 group">
                            ...
                            <div className="relative z-0 w-full mb-6 group">
                                <input type="tel" maxLength={10} name="floating_no" id="no" className="px-1 text-gray-500 rounded-md block py-2.5 w-full text-sm bg-transparent border-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-brand-ember-l-3 peer" placeholder=" " required />
                                <label htmlFor="no" className="bg-white left-2 px-1 z-10 peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 origin-[0] peer-focus:left-2 peer-focus:text-brand-ember-l-3 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Mobile NO</label>
                            </div>
                            <div className="relative z-0 w-full mb-6 group">
